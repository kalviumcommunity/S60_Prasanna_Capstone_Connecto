...
//     window.history.replaceState(null, '', '/Mainpg');
//     navigate('/Mainpg');
//   };
...
//       const res = await axios.post('http://localhost:5335/login', formData);
...
//         // history.replace('/Mainpg');
//         // props.histroy.replace('/Mainpg');
//       }
//     } catch (error) {
...
//     try {
//       const response = await axios.post('http://localhost:5335/google-login', {
//         token: res.tokenId,
//       });
